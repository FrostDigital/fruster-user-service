...
module.exports = {
    ...
    service: {
        ...
        DELETE_USERS_BY_QUERY: {
            description: `Deletes users by a query. Response has status code \`200\` if successful. ${Publishes.subjects.USER_DELETED} is published after deletion.`,
            errors: {
