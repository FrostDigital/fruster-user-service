...
const shared = {
    ...
    UPDATE_USER: {
        description: "Updates a user. Can contain any number of custom fields. Response has status code 200 if successful. Automatically splits data between user and profile if configured to.",
        errors: {
    ...
    DELETE_USER: {
        description: "Deletes a user. Response has status code 200 if successful. `pub.user-service.user-deleted` is published after deletion",
        errors: {
...
module.exports = {
    ...
    service: {
        ...
        GET_USERS_BY_QUERY: {
            description: `Gets users by query. Return data may vary depending on the configuration. Can be expanded to return both user and profile data if configured to split the data.`,
            errors: {
                "user-service.INTERNAL_SERVER_ERROR": "Something unexpected happened.",
                "user-service.400.13": "Invalid json. Query includes salt or password or query is empty (and config.allowGetAll is false)"
            }
        ...
        GET_PROFILES_BY_QUERY: {
            description: "Gets profiles by query. Return data may vary depending on the configuration.",
            errors: {
                "user-service.INTERNAL_SERVER_ERROR": "Something unexpected happened.",
