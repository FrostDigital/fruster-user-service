...
const errors = [
    ...
    { status: 400, code: "CANNOT_DELETE_SUPER_ADMIN", title: "Cannot delete super-admin role", detail: (role) => `Cannot delete super-admin role as it is needed to access the interface` }
