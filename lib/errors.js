...
const errors = [
    ...
    { status: 400, code: "BAD_REQUEST", title: "Request has invalid or missing fields", detail: (detail) => { return detail; } },

    { status: 401, code: "UNAUTHORIZED", title: "Unauthorized" },

    { status: 401, code: "PASSWORD_REQUIRED", title: "Password required", detail: "Password required to update email." },
    ...
    { status: 400, code: "*_NOT_UNIQUE", title: "* is not unique", detail: (field, fieldValue) => `Another account has already been registered with the provided ${field}: ${fieldValue}` },
    ...
    { status: 400, code: "CANNOT_DELETE_SUPER_ADMIN", title: "Cannot delete super-admin role", detail: () => `Cannot delete super-admin role as it is needed to access the interface` }
