    ...
    endpoints: {
        ...
        http: {
            ...
            admin: {
                ...
                REMOVE_SYSTEM_ROLE: "http.delete.admin.system.role.:role",
                ADD_SYSTEM_ROLE_SCOPES: "http.post.admin.system.role.:role.scope",
                REMOVE_SYSTEM_ROLE_SCOPES: "http.delete.admin.system.role.:role.scope",
            },
