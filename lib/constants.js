...
module.exports = {
    ...
    endpoints: {
        ...
        service: {
            ...
            ADD_SYSTEM_ROLE: "user-service.add-system-role",
            REMOVE_SYSTEM_ROLE: "user-service.remove-system-role",
            ADD_SCOPES_TO_SYSTEM_ROLE: "user-service.add-scopes-to-system-role",
            REMOVE_SCOPES_FROM_SYSTEM_ROLE: "user-service.remove-scopes-from-system-role",
        }
