...
class CreateUserHandler {
    ...
    async handle(req) {
        try {
            ...
            console.log("user");
            console.log("=======================================");
            console.log(require("util").inspect(createdUser, null, null, true));
            console.log("=======================================");
            console.log("profile");
            console.log("=======================================");
            console.log(require("util").inspect(profile, null, null, true));
            console.log("\n");
    ...
    async _splitUser(inputData) {
        ...
        const secondaryData = addFieldsToObject(inputData, Object.keys(inputData).filter(key => !this._fields[primarySource].includes(key)));
