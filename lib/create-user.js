...
function invalidJsonError(message, detail) {
...
function UserModel(requestBody) {
	...
	this.firstName = requestBody.firstName.toLowerCase();
	this.lastName = requestBody.lastName.toLowerCase();
	this.middleName = requestBody.middleName ? requestBody.middleName.toLowerCase() : undefined;
	this.email = requestBody.email.toLowerCase();
