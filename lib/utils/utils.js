...
function cleanUserModelOutput(user) {
	...
	const rolesWithPermissions = getRoles();
 ...
 * @return {Array}
 */
function getScopesForRoles(roles) {
	const scopes = [];
	const rolesWithPermissions = getRoles();
